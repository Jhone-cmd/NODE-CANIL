...
const home = (req, res) => {
    ...
    res.render('pages/page', {
        menu: (0, createMenuObject_1.createMenuObeject)('all'),
        banner: {
...
const dogs = (req, res) => {
    ...
    res.render('pages/page', {
        menu: (0, createMenuObject_1.createMenuObeject)('dog'),
        banner: {
            title: 'Cachorros',
...
const cats = (req, res) => {
    ...
    res.render('pages/page', {
        menu: (0, createMenuObject_1.createMenuObeject)('cat'),
        banner: {
            title: 'Gatos',
...
const fishes = (req, res) => {
    ...
    res.render('pages/page', {
        menu: (0, createMenuObject_1.createMenuObeject)('fish'),
        banner: {
            title: 'Peixes',
